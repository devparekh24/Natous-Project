...
var displayAlert = exports.displayAlert = function displayAlert(type, msg) {
  hideAlert();
...
var displayMap = exports.displayMap = function displayMap(locatios) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGV2MDM4IiwiYSI6ImNsb2d1ZmpqdTB6anMycW8zdnV2OGU5cm8ifQ.-dXmXJsE7o0f2A_-COtM5A';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/dev038/cloh4z1l8000j01pbap452lxn',
    // style URL
    scrollZoom: false
...
var locatios = JSON.parse(document.getElementById('map').dataset.locations);
(0, _mapbox.displayMap)(locatios);
